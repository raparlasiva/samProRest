...
cssdropdown.startchrome("chromemenu")
	...
	<tr>
		<td height="1116" colspan="9" valign="top" bgcolor="#FFFFFF" >
...
<TABLE WIDTH="85%" BORDER="0" CELLPADDING="0" CELLSPACING="0"
	...
	<TR>
		...
		<p class="norm">&nbsp;</p>
		<p class="norm"><strong><em>**To search specifically by meeting name or location, etc.; Click &quot;Search&quot; button below (To list ALL meetings), then type &quot;Ctrl&quot; + &quot;F&quot;, then type in the appropriate search criteria.</em></strong></p>
		<p class="norm">&nbsp;</p>
		<p class="norm">***A directory listing does NOT constitute or imply approval or endorsement of any Group's approach to, or practice of the Traditional AA program.</p>
<p class="BigHeading"></p>
        <p class="norm">&nbsp;</p>
		<p>&nbsp;</p>
	...
	<TR>
		...
		<TABLE WIDTH="80%" BORDER="0" CELLSPACING="2" CELLPADDING="2"
			...
			<TR VALIGN="bottom">
				<TD COLSPAN="6" VALIGN="top" NOWRAP class="Heading"><p>&nbsp;</p>
				  <p><STRONG>Meeting Search</STRONG></p></TD>
				<TD NOWRAP>&nbsp;</TD>
			</TR>
			<TR>
        ...
        <p class="chromestyle">&nbsp;</p>
        <p class="BigHeading">MEETING CODE
</p>
        <p class="standardtext">C - Closed Meeting (For Acoholics Only)</p>
<p class="standardtext">O - Open Meeting (Anyone May Attend)</p>
		<p class="standardtext">D - Discussion Meeting (Topic Selected and Discussed Amongst Group)</p>
		<p class="standardtext">S - Speaker Meeting (1 or 2 people Share Their Story)</p>
		<p class="standardtext">LIT - Literature Meeting (AA Literature Studied and Discussed)</p>
		<p class="standardtext">D/S - Discussion and Speaker	Meeting	</p>
		<p class="standardtext">NS - No Smoking</p>
		<p class="standardtext">M - Men's Meeting</p>
		<p class="standardtext">W - Women's Meeting</p>
		<p class="standardtext">YP - Young People</p>
		<p class="standardtext">*** - Gay and Lesbian</p>
		<p class="standardtext">WCA - Wheel Chair Accessible		</p>
		<p class="standardtext">AFG - Alanon Same Location</p>
		<p class="standardtext">ATN - Alateen Same Location</p>
		<p class="standardtext">ASL - American Sign Language		</p>
		<p class="standardtext">&nbsp;</p></TD>
	</TR>
</TABLE>
</FORM>
