...
//                    break;
//            }
            html += '<ul class="dropdown-menu" role="menu"><li ng-repeat="item in items"><a tabindex="-1" data-ng-click="selectVal(item)">{{item.name}}</a></li></ul></div><input type="text" class="form-control" ng-model="selectedItem"></div>';
